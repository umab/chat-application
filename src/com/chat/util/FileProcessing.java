...
public class FileProcessing{
    ...
    public static void main(String [] args){
    	try {
			byte [] readFile = FileProcessing.readBytesFromFile(new File("E:/files_for_program/client/file1.txt"));
			
			FileProcessing.writeBytesToFile(new File("E:/files_for_program/client/test.txt"), readFile);
		} catch (IOException e) {
